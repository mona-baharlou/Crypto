...
The app utilizes **Kotlin** for development, **MVVM** for better maintenance, **Hilt for dependency injection**, **Retrofit for network requests**, **Glide for image loading**, and **Spark library** for displaying charts.
